...
public class Bootstrapper : BootstrapperBase
{
    ...
    protected override void Configure()
    {
        try
        {
            XmlConfigurator.ConfigureAndWatch(new FileInfo(Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) ?? string.Empty, "D2RLauncher.log4net.config")));
